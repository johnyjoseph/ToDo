    ...
    .catch(function(e){console.log("not completed");})
        ...
        function fetchUserData()
        {
            ...
            { document.getElementById("demo").innerHTML=" <br>    Fetching......"
                ...
                for(i=1;i<=1;i++)
                {
                    output+="<tr> <td>ID</td><td>TITILE</td><td>IS COMPLEATED</td><td>CHECK BOX</td>";
        ...
        //                       {
        //                           output += "<tr> <td>" + response[i].id + "</td><td>" +response[i].title + "</td><td>" +  response.completed + "</td><td> <input type = checkbox  > </td></tr>";
